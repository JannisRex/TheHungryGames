module.exports = {
    ...
    "@typescript-eslint/no-magic-numbers": 2,    //Disallows magic numbers
    ...
    "@typescript-eslint/no-var-requires": 2,  //Disallows the use of require statements except in import statements
    ...
    "@typescript-eslint/prefer-function-type": 1,    // Use function types instead of interfaces with call signatures
    "@typescript-eslint/prefer-includes": 2,  //Enforce includes method over indexOf method
    "@typescript-eslint/prefer-namespace-keyword": 2,     //Require the use of the namespace keyword instead of the module keyword to declare custom TypeScript modules
    "@typescript-eslint/prefer-readonly": 2,  //Requires that private members are marked as readonly if they're never modified outside of the constructor
    "@typescript-eslint/prefer-regexp-exec": 2,  //Prefer RegExp#exec() over String#match() if no global flag is provided
    "@typescript-eslint/prefer-string-starts-ends-with": 2,   //Enforce the use of String#startsWith and String#endsWith instead of other equivalent methods of checking substrings
    "@typescript-eslint/promise-function-async": 2,   //Requires any function or method that returns a Promise to be marked async
    // "@typescript-eslint/quotes": 2,   //Enforce the consistent use of either backticks, double, or single quotes
    "@typescript-eslint/require-array-sort-compare": 2,   //Enforce giving compare argument to Array#sort
    "@typescript-eslint/require-await": 0,    //Disallow async functions which have no await expression
